...
[_BASE] = LAYOUT_all( LT(_NAV, KC_BSPC), KC_NO, KC_NO, KC_NO, KC_NO, KC_SPC), LT(_NUM_SYM, KC_NO, KC_NO, KC_NO, KC_LCTL, RSFT_T(KC_DOT), KC_NO, KC_COMM, KC_M, KC_N, KC_B, KC_V, KC_C, KC_X, LSFT_T(KC_Z), KC_ENT, KC_L, KC_K, KC_J, KC_H, KC_G, KC_F, KC_D, KC_S, KC_A, KC_P, KC_O, KC_I, KC_U, KC_Y, KC_T, KC_R, KC_E, KC_W, KC_Q),
