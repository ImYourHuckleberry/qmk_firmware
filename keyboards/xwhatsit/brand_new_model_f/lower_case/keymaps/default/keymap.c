...
[_BASE] = LAYOUT_all( LT(_NAV, KC_BSPC), KC_NO, KC_NO, KC_NO, KC_NO, LT(_NUM_SYM, KC_SPC), KC_NO, KC_NO, KC_NO, KC_LCTL, RSFT_T(KC_DOT), KC_NO, KC_COMM, KC_M, KC_N, KC_B, KC_V, KC_C, KC_X, LSFT_T(KC_Z), KC_ENT, KC_L, KC_K, KC_J, KC_H, KC_G, KC_F, KC_D, KC_S, KC_A, KC_P, KC_O, KC_I, KC_U, KC_Y, KC_T, KC_R, KC_E, KC_W, KC_Q),
[_NUM_SYM] = LAYOUT_all( LT(_FUNCTION, KC_NO), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_SLSH, KC_NO, KC_BSLS, KC_RCBR, KC_RBRC, KC_RPRN, KC_SCLN, KC_LPRN, KC_LBRC, KC_LCBR, KC_QUOT, KC_GRV, KC_EQL, KC_MINS, KC_GT, KC_LT, KC_F, KC_D, KC_S, KC_TAB, KC_0, KC_9, KC_8, KC_7, KC_6, KC_5, KC_4, KC_3, KC_2, KC_1),
[_NAV] =LAYOUT_all(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LGUI, KC_NO, KC_F12, KC_F11, KC_F10, KC_F9, KC_NO, KC_DEL, KC_LALT, KC_LCTL, KC_LCAP, KC_F8, KC_F7, KC_F6, KC_F5, KC_NO, KC_NO, KC_NO, KC_RGHT, KC_DOWN, KC_LEFT, KC_F4, KC_F3, KC_F2, KC_F1, KC_NO, KC_VOLU, KC_VOLD, KC_MUTE, KC_UP, KC_GESC),
[_FUNCTION] = LAYOUT_all(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, EEP_RST, RESET, HPT_DWLD, HPT_DWLI, HPT_FBK, HPT_RST, HPT_TOG)
